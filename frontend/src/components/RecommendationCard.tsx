...
const RANK_COLORS = ["var(--brand)", "#6b7280", "#d97706"];
      ...
      <div className="rec-product-header">
        ...
        <div className="rec-product-info">
          <div className="rec-product-name-row">
            ...
            <span className="priority-badge" style={{ background: priority.bg, color: priority.color, border: `1px solid ${priority.border}` }}>
              {priority.label}
            </span>
          </div>
          <div className="score-bar-row">
            <div className="score-bar-track">
              <div
                ...
                style={{ width: `${p.score ?? 0}%`, background: isTop ? "var(--brand)" : "#6b7280" }}
              />
            </div>
      ...
      {open && (
        <div className="expanded-section">
          <div className="outlook-box">
            ...
            <p style={{ fontSize: 13, color: "var(--text-2)", lineHeight: 1.65 }}>{p.long_term_outlook}</p>
          </div>
      ...
      {recommendation.top_pick && (
        <div className="top-pick-banner">
          <div className="top-pick-banner-title">
            ...
            <strong style={{ marginLeft: 4 }}>{recommendation.top_pick}</strong>
          </div>
