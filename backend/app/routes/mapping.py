...
def map_columns(request: MappingRequest):
    ...
    # 🔥 NEW: Extract Metadata for Lightning-Fast Queries
    columns = []
    column_types = {}
    column_values = {}
    ...
    # Update MongoDB with mapping AND the new metadata
    update_mapping(request.file_id, mapping, columns, column_types, column_values)
